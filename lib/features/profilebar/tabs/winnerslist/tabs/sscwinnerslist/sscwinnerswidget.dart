...
class Sscwinnerswidget extends StatefulWidget {
  final String examTitle;
  final String exam;
  const Sscwinnerswidget({super.key, required this.examTitle,required this.exam});

  @override
  State<Sscwinnerswidget> createState() => _SscwinnerswidgetState();
}

class _SscwinnerswidgetState extends State<Sscwinnerswidget> {
  @override
